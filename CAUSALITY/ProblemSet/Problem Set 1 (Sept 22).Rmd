...
```
For Colorado, the difference in means SATE is roughly 0.045 meaning those drafted were slightly more liberal than those not drafted. We see the opposite in Oregon, with a difference in means SATE of -0.061, where those drafted were slightly more likely to be 
