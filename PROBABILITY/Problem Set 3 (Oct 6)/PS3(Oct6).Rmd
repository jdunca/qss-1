...
realhist <- hist(as.numeric(top10list),  main = "Top vote share fractions", xlab = "fraction", ylab = "frequency", xlim = c(0.3, 1), ylim = c(0, 600), breaks = seq(0, 1, by = 0.01))

simhist <- hist(as.numeric(top10frac),  main = "Top vote share fractions (sim)", xlab = "fraction", ylab = "frequency", xlim = c(0.3, 1), ylim = c(0, 600), breaks = seq(0, 1, by = 0.01))
```
